(function($){
  $(function(){
    ...
    {selector: '#hobbies-bar', offset: 50, callback: 'Materialize.showStaggeredList("#hobbies-bar");' },
    {selector: '#languages-bar', offset: 50, callback: 'Materialize.showStaggeredList("#languages-bar");' }
  		];
